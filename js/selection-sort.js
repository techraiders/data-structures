...
- Use your comparator function to verify that sort is stable by taking input: [{value: 15}, {value: 10, order: 1}, {value: 10, order: 2}]

-Implement selection sort for a linked list. How does this impact performance and stability
*/
...
var selectionSort = function  (array, comparator) {
	...
	array.forEach(function  (element, index) {
		// for each position, find index of minimun value in subarray starting at that positions
		...
		// swaps values at min index and current position
