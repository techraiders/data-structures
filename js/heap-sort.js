...
2) Create sorted array by iteratively removing the largest element from the heap and inserting into the sorted array.
...
Example:
Note that the array is separate into two portions -
	heap | sorted
[ 7 2 5 1|8 9 10]
